                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200 text-xs font-semibold text-gray-600 uppercase tracking-wider">
                            ...
                            @else
                                <th class="px-6 py-3 text-right">Comprar</th>
                            @endif
                        </tr>
                    </thead>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                @else
                                    <td class="px-6 py-4 text-right">
                                        @if(in_array($car->id, $purchasedCarIds))
                                            <span class="inline-flex items-center px-3 py-1.5 bg-green-100 text-green-700 text-xs font-semibold rounded-lg">
                                                Comprado
                                            </span>
                                        @else
                                            <form action="{{ route('cars.buy', $car->id) }}" method="POST" class="inline" onsubmit="return confirm('Confirmar compra do veículo {{ $car->marca }} {{ $car->modelo }} por {{ number_format($car->preco, 2, ',', '.') }} KZ?')">
                                                @csrf
                                                <button type="submit" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-lg shadow transition">
                                                    Comprar
                                                </button>
                                            </form>
                                        @endif
